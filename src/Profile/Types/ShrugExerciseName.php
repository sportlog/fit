...
final class ShrugExerciseName
{
    ...
    public const WIDE_GRIP_BARBELL_SHRUG = 17;
    public const BEHIND_THE_BACK_SHRUG = 18;
    public const DUMBBELL_SHRUG_WHEELCHAIR = 19;
    public const SHRUG_WHEELCHAIR = 20;
    public const SHRUG_ARM_DOWN_WHEELCHAIR = 21;
    public const SHRUG_ARM_MID_WHEELCHAIR = 22;
    public const SHRUG_ARM_UP_WHEELCHAIR = 23;
    public const UPRIGHT_ROW = 24;
}
