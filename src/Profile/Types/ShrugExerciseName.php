...
final class ShrugExerciseName
{
    ...
    const WIDE_GRIP_BARBELL_SHRUG = 17;
    const BEHIND_THE_BACK_SHRUG = 18;
    const DUMBBELL_SHRUG_WHEELCHAIR = 19;
    const SHRUG_WHEELCHAIR = 20;
    const SHRUG_ARM_DOWN_WHEELCHAIR = 21;
    const SHRUG_ARM_MID_WHEELCHAIR = 22;
    const SHRUG_ARM_UP_WHEELCHAIR = 23;
    const UPRIGHT_ROW = 24;
}
