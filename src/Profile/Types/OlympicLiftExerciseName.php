...
final class OlympicLiftExerciseName
{
    ...
    public const DUMBBELL_HANG_SNATCH = 21;
    public const DUMBBELL_POWER_CLEAN_AND_JERK = 22;
    public const DUMBBELL_POWER_CLEAN_AND_PUSH_PRESS = 23;
    public const DUMBBELL_POWER_CLEAN_AND_STRICT_PRESS = 24;
    public const DUMBBELL_SNATCH = 25;
    public const MEDICINE_BALL_CLEAN = 26;
    public const CLEAN_AND_PRESS = 27;
    public const SNATCH = 28;
}
