...
final class Manufacturer
{
    ...
    public const ABAWO = 151;
    public const BAFANG = 152;
    public const LUHONG_TECHNOLOGY = 153;
    ...
    public const ICTRAINER = 328;
    public const ABSOLUTE_CYCLING = 329;
    public const EO_SWIMBETTER = 330;
    public const MYWHOOSH = 331;
    public const RAVEMEN = 332;
    public const TEKTRO_RACING_PRODUCTS = 333;
    public const DARAD_INNOVATION_CORPORATION = 334;
    public const CYCLOPTIM = 335;
    public const RUNNA = 337;
    public const ZEPP = 339;
    public const PELOTON = 340;
    public const CARV = 341;
    public const TISSOT = 342;
    public const REAL_VELO = 345;
    public const WETECH = 346;
    public const JESPR = 347;
