...
final class Manufacturer
{
    ...
    const BOSCH = 137;
    const KYTO = 138;
    const KINETIC_SPORTS = 139;
    const DECATHLON_BYTE = 140;
    const TQ_SYSTEMS = 141;
    const TAG_HEUER = 142;
    const KEISER_FITNESS = 143;
    const ZWIFT_BYTE = 144;
    const PORSCHE_EP = 145;
    const BLACKBIRD = 146;
    const MEILAN_BYTE = 147;
    const EZON = 148;
    const LAISI = 149;
    const MYZONE = 150;
    const ABAWO = 151;
    const BAFANG = 152;
    const LUHONG_TECHNOLOGY = 153;
    ...
    const SYNCROS = 311;
    const HEATUP = 312;
    const CANNONDALE = 313;
    const TRUE_FITNESS = 314;
    const RGT_CYCLING = 315;
    const VASA = 316;
    const RACE_REPUBLIC = 317;
    const FAZUA = 318;
    const OREKA_TRAINING = 319;
    const LSEC = 320;
    const LULULEMON_STUDIO = 321;
    const SHANYUE = 322;
    const SPINNING_MDA = 323;
    const HILLDATING = 324;
    const AERO_SENSOR = 325;
    const NIKE = 326;
    const MAGICSHINE = 327;
    const ICTRAINER = 328;
    const ABSOLUTE_CYCLING = 329;
    const EO_SWIMBETTER = 330;
    const MYWHOOSH = 331;
    const RAVEMEN = 332;
