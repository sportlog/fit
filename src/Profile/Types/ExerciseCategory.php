...
final class ExerciseCategory
{
    ...
    public const RUN = 32;
    public const BIKE = 33;
    public const CARDIO_SENSORS = 34;
    public const MOVE = 35;
    public const POSE = 36;
    public const BANDED_EXERCISES = 37;
    public const BATTLE_ROPE = 38;
    public const ELLIPTICAL = 39;
    public const FLOOR_CLIMB = 40;
    public const INDOOR_BIKE = 41;
    public const INDOOR_ROW = 42;
    public const LADDER = 43;
    public const SANDBAG = 44;
    public const SLED = 45;
    public const SLEDGE_HAMMER = 46;
    public const STAIR_STEPPER = 47;
    public const SUSPENSION = 49;
    public const TIRE = 50;
    public const RUN_INDOOR = 52;
    public const BIKE_OUTDOOR = 53;
