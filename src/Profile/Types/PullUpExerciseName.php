...
final class PullUpExerciseName
{
    ...
    const PULL_UP = 38;
    const CHIN_UP = 39;
    const NEUTRAL_GRIP_CHIN_UP = 40;
    const WEIGHTED_CHIN_UP = 41;
    const BAND_ASSISTED_PULL_UP = 42;
    const NEUTRAL_GRIP_PULL_UP = 43;
    const WEIGHTED_NEUTRAL_GRIP_CHIN_UP = 44;
    const WEIGHTED_NEUTRAL_GRIP_PULL_UP = 45;
}
