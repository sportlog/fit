...
final class CurlExerciseName
{
    ...
    const ONE_ARM_CONCENTRATION_CURL = 44;
    const STANDING_ZOTTMAN_BICEPS_CURL = 45;
    const DUMBBELL_BICEPS_CURL = 46;
    const DRAG_CURL_WHEELCHAIR = 47;
    const DUMBBELL_BICEPS_CURL_WHEELCHAIR = 48;
    const BOTTLE_CURL = 49;
    const SEATED_BOTTLE_CURL = 50;
}
