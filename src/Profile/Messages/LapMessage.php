...
#[Field('EndPositionLat', 5, FitBaseType::Sint32->value, 1.0, 0.0, 'semicircles', false, ProfileType::SINT32)]
#[Field('EndPositionLong', 6, FitBaseType::Sint32->value, 1.0, 0.0, 'semicircles', false, ProfileType::SINT32)]
...
#[Field('TotalFatCalories', 12, FitBaseType::Uint16->value, 1.0, 0.0, 'kcal', false, ProfileType::UINT16)]
#[Field('AvgSpeed', 13, FitBaseType::Uint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::UINT16)]
#[Field('MaxSpeed', 14, FitBaseType::Uint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::UINT16)]
#[Field('AvgHeartRate', 15, FitBaseType::Uint8->value, 1.0, 0.0, 'bpm', false, ProfileType::UINT8)]
#[Field('MaxHeartRate', 16, FitBaseType::Uint8->value, 1.0, 0.0, 'bpm', false, ProfileType::UINT8)]
#[Field('AvgCadence', 17, FitBaseType::Uint8->value, 1.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('MaxCadence', 18, FitBaseType::Uint8->value, 1.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('AvgPower', 19, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('MaxPower', 20, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('TotalAscent', 21, FitBaseType::Uint16->value, 1.0, 0.0, 'm', false, ProfileType::UINT16)]
#[Field('TotalDescent', 22, FitBaseType::Uint16->value, 1.0, 0.0, 'm', false, ProfileType::UINT16)]
#[Field('Intensity', 23, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::INTENSITY)]
#[Field('LapTrigger', 24, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::LAPTRIGGER)]
#[Field('Sport', 25, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::SPORT)]
#[Field('EventGroup', 26, FitBaseType::Uint8->value, 1.0, 0.0, '', false, ProfileType::UINT8)]
#[Field('NumLengths', 32, FitBaseType::Uint16->value, 1.0, 0.0, 'lengths', false, ProfileType::UINT16)]
#[Field('NormalizedPower', 33, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('LeftRightBalance', 34, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::LEFTRIGHTBALANCE100)]
#[Field('FirstLengthIndex', 35, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('AvgStrokeDistance', 37, FitBaseType::Uint16->value, 100.0, 0.0, 'm', false, ProfileType::UINT16)]
#[Field('SwimStroke', 38, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::SWIMSTROKE)]
#[Field('SubSport', 39, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::SUBSPORT)]
#[Field('NumActiveLengths', 40, FitBaseType::Uint16->value, 1.0, 0.0, 'lengths', false, ProfileType::UINT16)]
#[Field('TotalWork', 41, FitBaseType::Uint32->value, 1.0, 0.0, 'J', false, ProfileType::UINT32)]
#[Field('AvgAltitude', 42, FitBaseType::Uint16->value, 5.0, 500.0, 'm', false, ProfileType::UINT16)]
#[Field('MaxAltitude', 43, FitBaseType::Uint16->value, 5.0, 500.0, 'm', false, ProfileType::UINT16)]
#[Field('GpsAccuracy', 44, FitBaseType::Uint8->value, 1.0, 0.0, 'm', false, ProfileType::UINT8)]
#[Field('AvgGrade', 45, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('AvgPosGrade', 46, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('AvgNegGrade', 47, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('MaxPosGrade', 48, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('MaxNegGrade', 49, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('AvgTemperature', 50, FitBaseType::Sint8->value, 1.0, 0.0, 'C', false, ProfileType::SINT8)]
#[Field('MaxTemperature', 51, FitBaseType::Sint8->value, 1.0, 0.0, 'C', false, ProfileType::SINT8)]
#[Field('TotalMovingTime', 52, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('AvgPosVerticalSpeed', 53, FitBaseType::Sint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::SINT16)]
#[Field('AvgNegVerticalSpeed', 54, FitBaseType::Sint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::SINT16)]
#[Field('MaxPosVerticalSpeed', 55, FitBaseType::Sint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::SINT16)]
#[Field('MaxNegVerticalSpeed', 56, FitBaseType::Sint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::SINT16)]
#[Field('TimeInHrZone', 57, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('TimeInSpeedZone', 58, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('TimeInCadenceZone', 59, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('TimeInPowerZone', 60, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('RepetitionNum', 61, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('MinAltitude', 62, FitBaseType::Uint16->value, 5.0, 500.0, 'm', false, ProfileType::UINT16)]
#[Field('MinHeartRate', 63, FitBaseType::Uint8->value, 1.0, 0.0, 'bpm', false, ProfileType::UINT8)]
#[Field('WktStepIndex', 71, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::MESSAGEINDEX)]
#[Field('OpponentScore', 74, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('StrokeCount', 75, FitBaseType::Uint16->value, 1.0, 0.0, 'counts', false, ProfileType::UINT16)]
#[Field('ZoneCount', 76, FitBaseType::Uint16->value, 1.0, 0.0, 'counts', false, ProfileType::UINT16)]
#[Field('AvgVerticalOscillation', 77, FitBaseType::Uint16->value, 10.0, 0.0, 'mm', false, ProfileType::UINT16)]
#[Field('AvgStanceTimePercent', 78, FitBaseType::Uint16->value, 100.0, 0.0, 'percent', false, ProfileType::UINT16)]
#[Field('AvgStanceTime', 79, FitBaseType::Uint16->value, 10.0, 0.0, 'ms', false, ProfileType::UINT16)]
#[Field('AvgFractionalCadence', 80, FitBaseType::Uint8->value, 128.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('MaxFractionalCadence', 81, FitBaseType::Uint8->value, 128.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('TotalFractionalCycles', 82, FitBaseType::Uint8->value, 128.0, 0.0, 'cycles', false, ProfileType::UINT8)]
#[Field('PlayerScore', 83, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('AvgTotalHemoglobinConc', 84, FitBaseType::Uint16->value, 100.0, 0.0, 'g/dL', false, ProfileType::UINT16)]
#[Field('MinTotalHemoglobinConc', 85, FitBaseType::Uint16->value, 100.0, 0.0, 'g/dL', false, ProfileType::UINT16)]
#[Field('MaxTotalHemoglobinConc', 86, FitBaseType::Uint16->value, 100.0, 0.0, 'g/dL', false, ProfileType::UINT16)]
#[Field('AvgSaturatedHemoglobinPercent', 87, FitBaseType::Uint16->value, 10.0, 0.0, '%', false, ProfileType::UINT16)]
#[Field('MinSaturatedHemoglobinPercent', 88, FitBaseType::Uint16->value, 10.0, 0.0, '%', false, ProfileType::UINT16)]
#[Field('MaxSaturatedHemoglobinPercent', 89, FitBaseType::Uint16->value, 10.0, 0.0, '%', false, ProfileType::UINT16)]
#[Field('AvgLeftTorqueEffectiveness', 91, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgRightTorqueEffectiveness', 92, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgLeftPedalSmoothness', 93, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgRightPedalSmoothness', 94, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgCombinedPedalSmoothness', 95, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('TimeStanding', 98, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('StandCount', 99, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('AvgLeftPco', 100, FitBaseType::Sint8->value, 1.0, 0.0, 'mm', false, ProfileType::SINT8)]
#[Field('AvgRightPco', 101, FitBaseType::Sint8->value, 1.0, 0.0, 'mm', false, ProfileType::SINT8)]
#[Field('AvgLeftPowerPhase', 102, FitBaseType::Uint8->value, 0.7111111, 0.0, 'degrees', false, ProfileType::UINT8)]
#[Field('AvgLeftPowerPhasePeak', 103, FitBaseType::Uint8->value, 0.7111111, 0.0, 'degrees', false, ProfileType::UINT8)]
#[Field('AvgRightPowerPhase', 104, FitBaseType::Uint8->value, 0.7111111, 0.0, 'degrees', false, ProfileType::UINT8)]
#[Field('AvgRightPowerPhasePeak', 105, FitBaseType::Uint8->value, 0.7111111, 0.0, 'degrees', false, ProfileType::UINT8)]
#[Field('AvgPowerPosition', 106, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('MaxPowerPosition', 107, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('AvgCadencePosition', 108, FitBaseType::Uint8->value, 1.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('MaxCadencePosition', 109, FitBaseType::Uint8->value, 1.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('EnhancedAvgSpeed', 110, FitBaseType::Uint32->value, 1000.0, 0.0, 'm/s', false, ProfileType::UINT32)]
#[Field('EnhancedMaxSpeed', 111, FitBaseType::Uint32->value, 1000.0, 0.0, 'm/s', false, ProfileType::UINT32)]
#[Field('EnhancedAvgAltitude', 112, FitBaseType::Uint32->value, 5.0, 500.0, 'm', false, ProfileType::UINT32)]
#[Field('EnhancedMinAltitude', 113, FitBaseType::Uint32->value, 5.0, 500.0, 'm', false, ProfileType::UINT32)]
#[Field('EnhancedMaxAltitude', 114, FitBaseType::Uint32->value, 5.0, 500.0, 'm', false, ProfileType::UINT32)]
#[Field('AvgLevMotorPower', 115, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('MaxLevMotorPower', 116, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('LevBatteryConsumption', 117, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgVerticalRatio', 118, FitBaseType::Uint16->value, 100.0, 0.0, 'percent', false, ProfileType::UINT16)]
#[Field('AvgStanceTimeBalance', 119, FitBaseType::Uint16->value, 100.0, 0.0, 'percent', false, ProfileType::UINT16)]
#[Field('AvgStepLength', 120, FitBaseType::Uint16->value, 10.0, 0.0, 'mm', false, ProfileType::UINT16)]
#[Field('AvgVam', 121, FitBaseType::Uint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::UINT16)]
#[Field('AvgDepth', 122, FitBaseType::Uint32->value, 1000.0, 0.0, 'm', false, ProfileType::UINT32)]
#[Field('MaxDepth', 123, FitBaseType::Uint32->value, 1000.0, 0.0, 'm', false, ProfileType::UINT32)]
#[Field('MinTemperature', 124, FitBaseType::Sint8->value, 1.0, 0.0, 'C', false, ProfileType::SINT8)]
#[Field('EnhancedAvgRespirationRate', 136, FitBaseType::Uint16->value, 100.0, 0.0, 'Breaths/min', false, ProfileType::UINT16)]
#[Field('EnhancedMaxRespirationRate', 137, FitBaseType::Uint16->value, 100.0, 0.0, 'Breaths/min', false, ProfileType::UINT16)]
...
#[Field('TotalGrit', 149, FitBaseType::Float32->value, 1.0, 0.0, 'kGrit', false, ProfileType::FLOAT32)]
#[Field('TotalFlow', 150, FitBaseType::Float32->value, 1.0, 0.0, 'Flow', false, ProfileType::FLOAT32)]
#[Field('JumpCount', 151, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('AvgGrit', 153, FitBaseType::Float32->value, 1.0, 0.0, 'kGrit', false, ProfileType::FLOAT32)]
#[Field('AvgFlow', 154, FitBaseType::Float32->value, 1.0, 0.0, 'Flow', false, ProfileType::FLOAT32)]
#[Field('TotalFractionalAscent', 156, FitBaseType::Uint8->value, 100.0, 0.0, 'm', false, ProfileType::UINT8)]
#[Field('TotalFractionalDescent', 157, FitBaseType::Uint8->value, 100.0, 0.0, 'm', false, ProfileType::UINT8)]
#[Field('AvgCoreTemperature', 158, FitBaseType::Uint16->value, 100.0, 0.0, 'C', false, ProfileType::UINT16)]
#[Field('MinCoreTemperature', 159, FitBaseType::Uint16->value, 100.0, 0.0, 'C', false, ProfileType::UINT16)]
#[Field('MaxCoreTemperature', 160, FitBaseType::Uint16->value, 100.0, 0.0, 'C', false, ProfileType::UINT16)]
