...
#[Field('Sport', 23, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::SPORT)]
#[Field('EventGroup', 24, FitBaseType::Uint8->value, 1.0, 0.0, '', false, ProfileType::UINT8)]
#[Field('NecLat', 25, FitBaseType::Sint32->value, 1.0, 0.0, 'semicircles', false, ProfileType::SINT32)]
#[Field('NecLong', 26, FitBaseType::Sint32->value, 1.0, 0.0, 'semicircles', false, ProfileType::SINT32)]
#[Field('SwcLat', 27, FitBaseType::Sint32->value, 1.0, 0.0, 'semicircles', false, ProfileType::SINT32)]
#[Field('SwcLong', 28, FitBaseType::Sint32->value, 1.0, 0.0, 'semicircles', false, ProfileType::SINT32)]
#[Field('Name', 29, FitBaseType::String->value, 1.0, 0.0, '', false, ProfileType::STRING)]
#[Field('NormalizedPower', 30, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('LeftRightBalance', 31, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::LEFTRIGHTBALANCE100)]
#[Field('SubSport', 32, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::SUBSPORT)]
#[Field('TotalWork', 33, FitBaseType::Uint32->value, 1.0, 0.0, 'J', false, ProfileType::UINT32)]
#[Field('AvgAltitude', 34, FitBaseType::Uint16->value, 5.0, 500.0, 'm', false, ProfileType::UINT16)]
#[Field('MaxAltitude', 35, FitBaseType::Uint16->value, 5.0, 500.0, 'm', false, ProfileType::UINT16)]
#[Field('GpsAccuracy', 36, FitBaseType::Uint8->value, 1.0, 0.0, 'm', false, ProfileType::UINT8)]
#[Field('AvgGrade', 37, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('AvgPosGrade', 38, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('AvgNegGrade', 39, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('MaxPosGrade', 40, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('MaxNegGrade', 41, FitBaseType::Sint16->value, 100.0, 0.0, '%', false, ProfileType::SINT16)]
#[Field('AvgTemperature', 42, FitBaseType::Sint8->value, 1.0, 0.0, 'C', false, ProfileType::SINT8)]
#[Field('MaxTemperature', 43, FitBaseType::Sint8->value, 1.0, 0.0, 'C', false, ProfileType::SINT8)]
#[Field('TotalMovingTime', 44, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('AvgPosVerticalSpeed', 45, FitBaseType::Sint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::SINT16)]
#[Field('AvgNegVerticalSpeed', 46, FitBaseType::Sint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::SINT16)]
#[Field('MaxPosVerticalSpeed', 47, FitBaseType::Sint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::SINT16)]
#[Field('MaxNegVerticalSpeed', 48, FitBaseType::Sint16->value, 1000.0, 0.0, 'm/s', false, ProfileType::SINT16)]
#[Field('TimeInHrZone', 49, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('TimeInSpeedZone', 50, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('TimeInCadenceZone', 51, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('TimeInPowerZone', 52, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('RepetitionNum', 53, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('MinAltitude', 54, FitBaseType::Uint16->value, 5.0, 500.0, 'm', false, ProfileType::UINT16)]
#[Field('MinHeartRate', 55, FitBaseType::Uint8->value, 1.0, 0.0, 'bpm', false, ProfileType::UINT8)]
#[Field('ActiveTime', 56, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('WktStepIndex', 57, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::MESSAGEINDEX)]
#[Field('SportEvent', 58, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::SPORTEVENT)]
#[Field('AvgLeftTorqueEffectiveness', 59, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgRightTorqueEffectiveness', 60, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgLeftPedalSmoothness', 61, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgRightPedalSmoothness', 62, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('AvgCombinedPedalSmoothness', 63, FitBaseType::Uint8->value, 2.0, 0.0, 'percent', false, ProfileType::UINT8)]
#[Field('Status', 64, FitBaseType::Enum->value, 1.0, 0.0, '', false, ProfileType::SEGMENTLAPSTATUS)]
#[Field('Uuid', 65, FitBaseType::String->value, 1.0, 0.0, '', false, ProfileType::STRING)]
#[Field('AvgFractionalCadence', 66, FitBaseType::Uint8->value, 128.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('MaxFractionalCadence', 67, FitBaseType::Uint8->value, 128.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('TotalFractionalCycles', 68, FitBaseType::Uint8->value, 128.0, 0.0, 'cycles', false, ProfileType::UINT8)]
#[Field('FrontGearShiftCount', 69, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('RearGearShiftCount', 70, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('TimeStanding', 71, FitBaseType::Uint32->value, 1000.0, 0.0, 's', false, ProfileType::UINT32)]
#[Field('StandCount', 72, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::UINT16)]
#[Field('AvgLeftPco', 73, FitBaseType::Sint8->value, 1.0, 0.0, 'mm', false, ProfileType::SINT8)]
#[Field('AvgRightPco', 74, FitBaseType::Sint8->value, 1.0, 0.0, 'mm', false, ProfileType::SINT8)]
#[Field('AvgLeftPowerPhase', 75, FitBaseType::Uint8->value, 0.7111111, 0.0, 'degrees', false, ProfileType::UINT8)]
#[Field('AvgLeftPowerPhasePeak', 76, FitBaseType::Uint8->value, 0.7111111, 0.0, 'degrees', false, ProfileType::UINT8)]
#[Field('AvgRightPowerPhase', 77, FitBaseType::Uint8->value, 0.7111111, 0.0, 'degrees', false, ProfileType::UINT8)]
#[Field('AvgRightPowerPhasePeak', 78, FitBaseType::Uint8->value, 0.7111111, 0.0, 'degrees', false, ProfileType::UINT8)]
#[Field('AvgPowerPosition', 79, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('MaxPowerPosition', 80, FitBaseType::Uint16->value, 1.0, 0.0, 'watts', false, ProfileType::UINT16)]
#[Field('AvgCadencePosition', 81, FitBaseType::Uint8->value, 1.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('MaxCadencePosition', 82, FitBaseType::Uint8->value, 1.0, 0.0, 'rpm', false, ProfileType::UINT8)]
#[Field('Manufacturer', 83, FitBaseType::Uint16->value, 1.0, 0.0, '', false, ProfileType::MANUFACTURER)]
#[Field('TotalGrit', 84, FitBaseType::Float32->value, 1.0, 0.0, 'kGrit', false, ProfileType::FLOAT32)]
#[Field('TotalFlow', 85, FitBaseType::Float32->value, 1.0, 0.0, 'Flow', false, ProfileType::FLOAT32)]
#[Field('AvgGrit', 86, FitBaseType::Float32->value, 1.0, 0.0, 'kGrit', false, ProfileType::FLOAT32)]
#[Field('AvgFlow', 87, FitBaseType::Float32->value, 1.0, 0.0, 'Flow', false, ProfileType::FLOAT32)]
#[Field('TotalFractionalAscent', 89, FitBaseType::Uint8->value, 100.0, 0.0, 'm', false, ProfileType::UINT8)]
#[Field('TotalFractionalDescent', 90, FitBaseType::Uint8->value, 100.0, 0.0, 'm', false, ProfileType::UINT8)]
#[Field('EnhancedAvgAltitude', 91, FitBaseType::Uint32->value, 5.0, 500.0, 'm', false, ProfileType::UINT32)]
#[Field('EnhancedMaxAltitude', 92, FitBaseType::Uint32->value, 5.0, 500.0, 'm', false, ProfileType::UINT32)]
#[Field('EnhancedMinAltitude', 93, FitBaseType::Uint32->value, 5.0, 500.0, 'm', false, ProfileType::UINT32)]
