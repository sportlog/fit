...
#[Field('StressLevel', 1, FitBaseType::Sint8->value, 1.0, 0.0, 's', false, ProfileType::SINT8)]
final class HsaStressDataMessage extends Message
{
    /**
     ...
     */
    public function getStressLevel(): int|array|null
    {
