...
class ProfileType
{
    ...
    public const MOVEEXERCISENAME = 'MoveExerciseName';
    public const POSEEXERCISENAME = 'PoseExerciseName';
    ...
    public const BIKEEXERCISENAME = 'BikeExerciseName';
    public const BANDEDEXERCISESEXERCISENAME = 'BandedExercisesExerciseName';
    public const BATTLEROPEEXERCISENAME = 'BattleRopeExerciseName';
    public const ELLIPTICALEXERCISENAME = 'EllipticalExerciseName';
    public const FLOORCLIMBEXERCISENAME = 'FloorClimbExerciseName';
    public const INDOORBIKEEXERCISENAME = 'IndoorBikeExerciseName';
    public const INDOORROWEXERCISENAME = 'IndoorRowExerciseName';
    public const LADDEREXERCISENAME = 'LadderExerciseName';
    public const SANDBAGEXERCISENAME = 'SandbagExerciseName';
    public const SLEDEXERCISENAME = 'SledExerciseName';
    public const SLEDGEHAMMEREXERCISENAME = 'SledgeHammerExerciseName';
    public const STAIRSTEPPEREXERCISENAME = 'StairStepperExerciseName';
    public const SUSPENSIONEXERCISENAME = 'SuspensionExerciseName';
    public const TIREEXERCISENAME = 'TireExerciseName';
    public const BIKEOUTDOOREXERCISENAME = 'BikeOutdoorExerciseName';
    public const RUNINDOOREXERCISENAME = 'RunIndoorExerciseName';
    ...
    public const SLEEPDISRUPTIONSEVERITY = 'SleepDisruptionSeverity';
    public const NAPPERIODFEEDBACK = 'NapPeriodFeedback';
    public const NAPSOURCE = 'NapSource';
