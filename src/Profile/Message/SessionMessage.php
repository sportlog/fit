...
final class SessionMessage extends Message
{
     ...
     */
    public function getFirstLapIndex(): int|null
    {
     ...
     * Gets the num laps
     */
    public function getNumLaps(): int|null
    {
     ...
     * Gets the trigger
     */
    public function getTrigger(): int|null
    {
     ...
     */
    public function getThresholdPower(): int|null
    {
     ...
     */
    public function getBestLapIndex(): int|null
    {
